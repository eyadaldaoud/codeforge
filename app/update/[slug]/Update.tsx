...
import { Review } from "@/app/upload/Review";
import { ScriptDataType } from "@/components/utils/Types";

const Update = ({ scriptData, scriptID }: any) => {
      ...
      <Card className="w-[600px] mr-4 mb-4">
        <form onSubmit={formik.handleSubmit}>
          <CardHeader>
            ...
            <CardDescription>
              Get started by filling the details for your updated script.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 w-full items-center gap-4">
              ...
              <div className="flex flex-col space-y-1.5">
                ...
                <Select onValueChange={(e) => setLanguage(e)}>
                  <SelectTrigger>
                    <SelectValue placeholder={data.scriptLang} />
                  </SelectTrigger>
